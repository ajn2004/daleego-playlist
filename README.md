...
- `PUT /api/v1/playlists/{id}/plex-items` - Reconcile an editor snapshot using `base_revision`, `ordered_queue_item_ids`, and explicit `removed_queue_item_ids`; Plex omissions are never treated as consumption
